function [c4nNew,n4eNew,n4sDbNew,n4sNbNew] = refineRGB(c4n,n4e,n4sDb,n4sNb,n4sMarked)
%% refineRGB - refine using the rgb-strategy
%   refineRGB(c4n, n4e, n4sDb, n4sNb, n4sMarked) Refines a given mesh using
%       the red green blue refinement. For details on data structures and
...
%       n4sDbNew and n4sNbNew.
    ...
    %% Compute newNodes4s to find new nodes faster.
	...
	nrNewNodes4curElem = nnz(curNewNodes);
        ...
        elseif nrNewNodes4curElem == 2
            ...
            ind = ind+3;
        elseif nrNewNodes4curElem == 3 % red refinement
            n4eNew(ind+1:ind+4,:) = ...
                [ curNodes(1)    curNewNodes(1) curNewNodes(3);
                  curNewNodes(1) curNodes(2)    curNewNodes(2);
